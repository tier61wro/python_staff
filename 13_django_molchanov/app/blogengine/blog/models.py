...
class Post(models.Model):
    title = models.CharField(max_length=150, db_index=True, verbose_name='Имя поста')
    ...
    def get_absolute_url(self): #имя лучше именно такое, возвращает ссылку на конкретный экземпляр класса Post
    ...
    class Meta:
        verbose_name_plural = 'Posts verbose' # это имя будет на админской страничке
        verbose_name = 'Post verbose'
        ordering = ['-date_pub'] # сортировка в обратном порядке
